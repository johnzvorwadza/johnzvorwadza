...
include "../functions.php";
	...
	///is dublicate?
	$qnumrows = $conn->prepare("SELECT * FROM `personnel` WHERE firstname = ? AND lastname = ?;");
	$qnumrows->bind_param("ss", $firstname, $lastname);
	$qnumrows->execute();
	...
	$query->bind_param("ssssi", $firstname, $lastname, $jobTitle, $email, $_REQUEST['departmentID']);
